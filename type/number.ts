...
// 확인하기
let exponentNum: number = 129435;
exponentNum.toExponential(3);  

// 2. toFixed() 
// * 고정 소수점 표기법을 문자열 형식으로 반환함

let FixedNum: number = 10.8788;
...
let LocalStringNum: number = 10667.987;
...
let precisionNum: number = 10.5679;

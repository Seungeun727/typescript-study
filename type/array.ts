...
// 1. 특정 문자 아이템만 허용함.
let stringList: string[] = [ 'Mike', 'doil', 'steve' ];
...
let anyList: any[] = [{ name: 'minji' }, 'Mike', 'doil', 'steve' ];
// anyList = true;  // error 발생

// 3.특정 데이터 타입만 배열 아이템으로 허용함.
// union type ( 다중 타입 )
let selectList: (number|string)[] = [ 100, 'Mike'];


// 실습 적용해보기

let memberList: string[] = [ '손흥민', '이승우', '이강인'];
...
let only_num_str_boo:(number | boolean | string )[] = [ 10, true, '프로그래밍'];
